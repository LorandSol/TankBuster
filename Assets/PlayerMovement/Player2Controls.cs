...
//     version 1.2.0
//     from Assets/PlayerMovement/Player2Controls.inputactions
//
...
public partial class @Player2Controls : IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Player2Movement_HorizontalMovement = m_Player2Movement.FindAction("HorizontalMovement", throwIfNotFound: true);
    }
    ...
    private IPlayer2MovementActions m_Player2MovementActionsCallbackInterface;
    private readonly InputAction m_Player2Movement_HorizontalMovement;
    public struct Player2MovementActions
    {
        private @Player2Controls m_Wrapper;
        public Player2MovementActions(@Player2Controls wrapper) { m_Wrapper = wrapper; }
        public InputAction @HorizontalMovement => m_Wrapper.m_Player2Movement_HorizontalMovement;
        ...
        {
            if (m_Wrapper.m_Player2MovementActionsCallbackInterface != null)
            {
                @HorizontalMovement.started -= m_Wrapper.m_Player2MovementActionsCallbackInterface.OnHorizontalMovement;
                @HorizontalMovement.performed -= m_Wrapper.m_Player2MovementActionsCallbackInterface.OnHorizontalMovement;
                @HorizontalMovement.canceled -= m_Wrapper.m_Player2MovementActionsCallbackInterface.OnHorizontalMovement;
            }
            m_Wrapper.m_Player2MovementActionsCallbackInterface = instance;
            if (instance != null)
            {
